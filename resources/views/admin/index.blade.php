        ...
        <div class="nk-content-body">
            ...
            <div class="nk-block-head">
                <div class="nk-block-head-between">
                    ...
                    <div class="nk-block-head-content">
                        <a href="document-saved.html" class="link"><span>See All</span> <em
                    ...
                    <table class="table table-middle mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="tb-col">
                                    <div class="caption-text">The Impact of Artificial Intelligence on the Future of Work
                                    </div>
                                </td>
                                ...
                                <td class="tb-col tb-col-md">
                                    <div class="fs-6 text-light d-inline-flex flex-wrap gap gx-2"><span>Feb 15,2023 </span>
                                        <span>02:31 PM</span></div>
                                </td>
                                <td class="tb-col tb-col-end">
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-icon btn-zoom me-n1" type="button"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <div class="dropdown-content">
                                                <ul class="link-list link-list-hover-bg-primary link-list-md">
                                                    <li>
                                                        <a href="#l"><em class="icon ni ni-eye"></em><span>View
                                                                Document</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="#"><em
                            ...
                            <tr>
                                ...
                                <td class="tb-col tb-col-sm">
                                    <div class="badge text-bg-blue-soft rounded-pill px-2 py-1 fs-6 lh-sm">Social Media
                                    </div>
                                </td>
                                <td class="tb-col tb-col-md">
                                    <div class="fs-6 text-light d-inline-flex flex-wrap gap gx-2"><span>Feb 15,2023 </span>
                            ...
                            <tr>
                                ...
                                <td class="tb-col">
                                    <div class="caption-text">Top 10 Tips for Effective Time Management in the Workplace
                                    </div>
                                </td>
                                <td class="tb-col tb-col-sm">
                                    <div class="badge text-bg-primary-soft rounded-pill px-2 py-1 fs-6 lh-sm">Blog Content
                                    </div>
                                </td>
                                <td class="tb-col tb-col-md">
                                    <div class="fs-6 text-light d-inline-flex flex-wrap gap gx-2"><span>Feb 15,2023 </span>
                            ...
                            <tr>
                                ...
                                <td class="tb-col tb-col-sm">
                                    <div class="badge text-bg-purple-soft rounded-pill px-2 py-1 fs-6 lh-sm">Website Copy
                                        &amp; SEO</div>
                                </td>
                                <td class="tb-col tb-col-md">
                                    <div class="fs-6 text-light d-inline-flex flex-wrap gap gx-2"><span>Feb 15,2023 </span>
