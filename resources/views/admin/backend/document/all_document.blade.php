                            ...
                            <tr>
                                ...
                                <td class="tb-col tb-col-md">
                                    <div class="fs-6 text-light d-inline-flex flex-wrap gap gx-2">
                                        {{ $item->template->title }} </div>
                                </td>
                                <td class="tb-col tb-col-md">
                                    <div class="fs-6 text-light d-inline-flex flex-wrap gap gx-2"> {{ $item->user->name }}
                                    </div>
                                </td>
                                ...
                                <td class="tb-col tb-col-sm">
                                    <a href="{{ route('edit.document', $item->id) }}" class="btn btn-success btn-sm">Edit</a>
                                    <a href="{{ route('delete.document', $item->id) }}" class="btn btn-danger btn-sm"
                                        id="delete">Delete</a>
                                </td>
