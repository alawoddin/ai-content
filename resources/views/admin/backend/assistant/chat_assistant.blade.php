        ...
        <div class="list-group list-group-flush">
            @foreach ($conversations as $conv)
             <a href="{{ route('chat-assistants.select',['assistantId' => $assistant->id, 'conversationId' => $conv->conversation_id ?? $conv->id ]) }}" 
                class="list-group-item list-group-item-action {{ $selectedConversation && ($selectedConversation->conversation_id ?? $selectedConversation->id) == 
                ($conv->conversation_id ?? $conv->id) ? 'active' : '' }}">
