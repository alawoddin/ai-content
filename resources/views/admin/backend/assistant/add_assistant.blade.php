                            ...
                            <div class="row g-3 gx-gs">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInputText1" class="form-label">Select Chat Assistants
                                            Avater </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInputText1" class="form-label">Active Chat Assistant
                                        </label>
                                        <div class="form-control-wrap">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInputText1" class="form-label">Chat Assistant Welcome
                                            Message </label>
                                        <div class="form-control-wrap">
