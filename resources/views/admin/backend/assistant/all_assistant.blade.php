                        ...
                        <div class="d-flex gap gx-4">
                            <div class="">
                                <ul class="d-flex gap gx-2">
                                    ...
                                    <li>
                                        <a href="templates-list.html" class="btn btn-md btn-icon btn-outline-light"><em
                                                class="icon ni ni-view-list-wd"></em></a>
                                    </li>
                                    <li>
                                        <a href="templates.html" class="btn btn-md btn-icon btn-primary btn-soft"><em
                                    ...
                                    <a href="{{ route('chat-assistants.chat', $item->id) }}">
                                        <div class="  text-primary  bg-opacity-20 mb-3">
                                            <img src="{{ !empty($item->avatar) ? url('upload/avatar/' . $item->avatar) : url('upload/no_image.jpg') }}"
                                                class="rounded-circle avatar-xl " style="width: 120px; height:100px;">
                                        </div>
