                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    ...
                    <div class="nk-block-head-content">
                        <ul class="nk-block-tools">
                            <li><a class="btn btn-primary" href="{{ route('add.questions') }}"><em
                                        class="icon ni ni-plus"></em><span>Add Question</span></a></li>
                        </ul>
                    </div>
                </div>
            </div><!-- .nk-page-head -->
                    ...
                    <tbody>
                        @foreach ($question as $key => $item)
                            <tr>
                                ...
                                <td class="tb-col tb-col-sm">
                                    <a href="{{ route('edit.questions', $item->id) }}"
                                        class="btn btn-success btn-sm">Edit</a>
                                    <a href="{{ route('delete.questions', $item->id) }}" class="btn btn-danger btn-sm"
                                        id="delete">Delete</a>
                                </td>
