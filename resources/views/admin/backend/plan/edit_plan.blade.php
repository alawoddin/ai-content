                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.plans') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 gx-gs">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInputText1" class="form-label">Monthly Word Limit
                                        </label>
                                        <div class="form-control-wrap">
                                            <input type="text" name="monthly_word_limit" class="form-control"
                                                value="{{ $plans->monthly_word_limit }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="number" name="templates" class="form-control"
                                                value="{{ $plans->templates }}">
                                        </div>
                                    </div>
                                </div>
