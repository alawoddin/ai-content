                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    ...
                    <div class="nk-block-head-content">
                        <ul class="nk-block-tools">
                            <li><a class="btn btn-primary" href="{{ route('add.plans') }}"><em
                        ...
                        @foreach ($plans as $key => $item)
                            <tr>
                                ...
                                <td class="tb-col tb-col-md">
                                    <div class="fs-6 text-light d-inline-flex flex-wrap gap gx-2"> {{ $item->name }}
                                    </div>
                                </td>
                                ...
                                <td class="tb-col tb-col-sm">
                                    ...
                                    <a href="{{ route('delete.plans', $item->id) }}" class="btn btn-danger btn-sm"
                                        id="delete">Delete</a>
                                </td>
