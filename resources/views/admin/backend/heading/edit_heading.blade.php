                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.heading') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 gx-gs">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" name="title" value="{{ $headings->title }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="exampleFormControlInputText1" class="form-label">Heading
                                            Description</label>
                                        <div class="form-control-wrap">
                                            <input type="text" name="description" value="{{ $headings->description }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
