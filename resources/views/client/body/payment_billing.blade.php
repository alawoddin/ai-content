...
<div class="tab-pane fade" id="payment-billing-tab-pane">
    <div class="d-flex flex-wrap align-items-center justify-content-between border-bottom border-light mt-5 mb-4 pb-1">
        ...
        <ul class="d-flex gap gx-4">
            <li>
                <a class="link link-danger fw-normal" data-bs-toggle="modal" href="#cancelSubscriptionModal">Cancel
                    Subscription</a>
            </li>
            <li>
    ...
    <div class="alert alert-warning alert-dismissible fade show mb-4 rounded-6" role="alert">
        <p class="small mb-0">Save big up to 75% on your upgrade to our <strong><a class="alert-link"
                    href="#">Enterprise plan</a></strong> and enjoy premium features at a fraction of the cost!
        </p>
    ...
    <div class="card">
        <table class="table table-middle mb-0">
            ...
            <tbody>
                @forelse ($profileData->billingHistories as $billing)
                    <tr>
                        <td class="tb-col">
                            <div class="caption-text">{{ $billing->plan->name }} - 1 Months <div
                                    class="d-sm-none dot bg-success"></div>
                            </div>
                        </td>
                        <td class="tb-col tb-col-md">
                            <div class="fs-6 text-light d-inline-flex flex-wrap gap gx-2">
                                <span>{{ \Carbon\Carbon::parse($billing->payment_date)->format('M d, Y') }} </span>
                                <span>{{ \Carbon\Carbon::parse($billing->payment_date)->format('h:i A') }}</span></div>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center">
                            <div class="caption-text">No Billing history found</div>
                        </td>
                    </tr>
                @endforelse
