            ...
            <div class="card shadow-none">
                <div class="card-body">
                    <div class="row">
                        ...
                        {{-- Right Sidebar  --}}
                        <div class="col-md-12">
                            <form action="{{ route('user.update.document', $document->id) }}" method="post"
                                id="editDocumentForm" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="nk-editor-header">
                                        ...
                                        <div class="nk-editor-tools d-none d-xl-flex">
                                            <ul class="d-inline-flex gap gx-3">
                                                <li>
                                                    <button type="submit" class="btn btn-md btn-primary rounded-pill">Save
                                                        Changes</button>
                                                </li>
                                            </ul>
                                        </div>
