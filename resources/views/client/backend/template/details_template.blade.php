            ...
            <div class="card shadow-none">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <p><strong>Your Blanace Is {{ $user->current_word_usage - $user->words_used }} Words Left
                                    </strong></p>
                            </div>

                            <form id="generateForm" action="{{ route('user.content.generate', $template->id) }}"
                                ...
                                @foreach ($template->inputFields as $field)
                                    <div class="form-group mt-3">
                                        ...
                                        @if ($field->type === 'text')
                                            <input type="text" name="{{ str_replace(' ', '_', $field->title) }}"
                                                id="{{ $field->title }}" class="form-control" required>
                                        @elseif ($field->type === 'textarea')
                                            <textarea name="{{ str_replace(' ', '_', $field->title) }}" id="{{ $field->title }}" rows="5" class="form-control"
                                                required></textarea>
                                        @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number" name="result_length" class="form-control"
                                                    id="result_length" value="200" min="50" max="1000"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="nk-editor-header">
                                    ...
                                    <div class="nk-editor-tools d-none d-xl-flex">
                                        <ul class="d-inline-flex gap gx-3 gx-lg-4 pe-4 pe-lg-5">
                                            <li>
                                                <span class="sub-text text-nowrap">Words <span class="text-dark"
                                                        id="word-count">0</span></span>
                                            </li>
                                            <li>
                                                <span class="sub-text text-nowrap">Characters <span class="text-dark"
                                                        id="char-count">0</span></span>
                                            </li>
                                        </ul>
                                        <ul class="d-inline-flex gap gx-3">
                                            <li>
                                                <div class="dropdown">
                                                    <button class="btn btn-md btn-light rounded-pill" type="button"
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="#" class="dropdown-item" id="copy-text"> Copy
                                                                Text </a>
                                                        </li>
                                                        <li>
                                            ...
                                            <li>
                                                <button class="btn btn-md btn-primary rounded-pill" type="button"> Save
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
    ...
    <script>
        ...
        document.querySelectorAll('.dropdown-menu .dropdown-item').forEach(item => {
            item.addEventListener('click', function(e) {
                ...
                const templateTitle = document.querySelector('.nk-editor-title h4').textContent.trim() ||
                    'Generated_Content';
