                        ...
                        <div class="col-xl-4 col-lg-7 col-md-9 me-auto order-xl-first">
                            <div class="block-text">
                                <a href="index.html" class="logo-link mb-4">
                                    <div class="logo-wrap">
                                        <img class="logo-img logo-light" src="{{ asset('frontend/images/logo.png') }}" srcset="{{ asset('frontend/images/logo2x.png') }}" alt="">
                                        <img class="logo-img logo-dark" src="{{ asset('frontend/images/logo-dark.png') }}" srcset="{{ asset('frontend/images/logo-dark2x.png') }}" alt="">
                                    </div>
                                </a>
                                ...
                                <p class="text-heading mt-4">&copy; 2023 Easylearning. Template Made By <a target="_blank" href="https://easylearningbd.com">EasyGen</a> </p>
                            </div>
                        </div>
                    </div>
                </div><!-- .container -->
