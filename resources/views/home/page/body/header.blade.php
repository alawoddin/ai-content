            ...
            <div class="nk-header-wrap">
                <div class="nk-header-logo">
                    <a href="{{ url('/') }}" class="logo-link">
                        <div class="logo-wrap">
                            <img class="logo-img logo-light" src="{{ asset('frontend/images/logo.png') }}"
                                srcset="{{ asset('frontend/images/logo2x.png 2x') }}" alt="">
                            <img class="logo-img logo-dark" src="{{ asset('frontend/images/logo-dark.png') }}"
                                srcset="{{ asset('frontend/images/logo-dark2x.png 2x') }}" alt="">
                        </div>
                    </a>
                </div><!-- .nk-header-logo -->
                ...
                <nav class="nk-header-menu nk-menu">
                    ...
                    <ul class="nk-menu-buttons flex-lg-row-reverse">
                        ...
                        <li>
                            @if (auth()->check())
                                <a target="/blank" class="link link-dark"
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        toggleButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                console.log('Toggled to isDark:', isDark, 'Classes before apply:', bodyElement
                    .classList);
                applyTheme(isDark);
                ...
                if (typeof window.jQuery !== 'undefined') {
                    jQuery('[class*="visible-on-"]').each(function() {
                        jQuery(this).toggleClass('d-none', !isDark && jQuery(this)
                            .hasClass('visible-on-dark-mode'));
                    });
                }
